...
@EnableWs
@Configuration
public class Covidsoapconfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema empSchema) {
        ...
        wsdl11Definition.setPortTypeName("CovidPort");
    ...
    public XsdSchema empSchema() {
        return new SimpleXsdSchema(new ClassPathResource("wsdl/covid.xsd"));
    }
}
